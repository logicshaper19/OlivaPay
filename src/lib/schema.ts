import { pgTable, bigint, text, timestamp, boolean, integer, varchar, numeric, char, serial } from 'drizzle-orm/pg-core';
...
export const companyDetails = pgTable('companydetails', {
  id: bigint('id', { mode: 'number' }).primaryKey().notNull(),
  employerId: bigint('employer_id', { mode: 'number' }).notNull().references(() => employers.id),
  companyName: text('company_name').notNull(),
  companyType: text('company_type').notNull(),
  website: text('website'),
  countryId: bigint('country_id', { mode: 'number' }).notNull().references(() => countryList.id),
...
export const users = pgTable('users', {
  id: bigint('id', { mode: 'number' }).primaryKey().notNull(),
  employerId: bigint('employer_id', { mode: 'number' }).references(() => employers.id),
